 		...
 		<div id="content">
 			...
 			<section id="col2">
 				...
 				<div id="view_button">
 					...
 					<!-- 수정 삭제는 본인글만 가능. or 레벨1단계 or 관리자만 가능. -->
 					<?php 
 						...
 						if ($userid == $item_id || $userlevel == 1 || $userid == "admin") {
 							...
 							<!-- 그 경고창에서 확인 또는 취소를 선택(confirm())하도록 유도. -->
 							<!-- 결과가 확인이면 그때 delete.php가 실행되도록. -->
 							<!-- a 클릭시 javascript로 작업. -->
 					...
 					<?php 
 						if ($userid) {
 							echo "<a href='write_form.php><img_src='../img/write.png></a>";
 						}
 					?>
 				</div>
 			</section>
